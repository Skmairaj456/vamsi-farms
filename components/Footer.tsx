...
export default function Footer() {
  return (
    <footer className="w-full bg-gradient-to-b from-neutral-dark to-neutral-dark text-white py-12 sm:py-16 px-4 sm:px-6 mt-12 sm:mt-16 md:mt-20">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 md:gap-12 mb-8 sm:mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3 text-sm sm:text-base text-neutral-grey">
              <li>
                <Link href="/products" className="hover:text-primary-green transition-colors block py-1">
                  Products
                </Link>
              </li>
              <li>
                <Link href="/cart" className="hover:text-primary-green transition-colors block py-1">
                  Cart
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3 text-sm sm:text-base text-neutral-grey">
              <li className="flex items-start gap-2">
                ...
                <span>hello@vamsifarms.com</span>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-5 h-5 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>Organic Farm, India</span>
              </li>
            </ul>
          </div>
        </div>
        <div className="border-t border-neutral-grey/30 pt-6 sm:pt-8 text-center text-xs sm:text-sm text-neutral-grey">
          <p>&copy; 2024 Vamsi.Farms. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
